...
class CountryFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        for ($i = 0; $i < count(self::COUNTRIES); $i++) {
            $country = new Country();
            $country->setName(self::COUNTRIES[$i][3]);
            $country->setCode(self::COUNTRIES[$i][2]);
            $country->setFlag('https://flagsapi.com/' . self::COUNTRIES[$i][2] . '/flat/64.png');
